...
public class InfixToPostfix implements Iterable<String> {
	...
	private Deque<String> postfix = new LinkedList<String>(); // Used as a queue of String
	private Deque<String> opStack = new LinkedList<String>(); // Used as an operator stack
